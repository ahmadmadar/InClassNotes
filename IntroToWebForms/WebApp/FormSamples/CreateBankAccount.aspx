    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <ul>
                ...
                <li>Add a Grid View control to this form</li>
                <li>In the code-behind, add a <code>static List&lt;BankAccount&gt;</code> property to hold the bank account information.</li>
                <li>Complete the <code>Submit_Click()</code> method to add the bank account to the Gridview. Check to Validation controls, and alos do a "manmual check" in the C# to ensure that there
                    are no duplicate account numbers in the list.</li>
            </ul>
