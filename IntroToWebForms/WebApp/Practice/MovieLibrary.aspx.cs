...
{
    public partial class MovieLibrary1 : System.Web.UI.Page
    {
...
namespace WebApp.Practice
{
    ...
    {
        private static List<Movie> library =
        new List<Movie>();
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                MessageLabel.Text = "Thank you for successfully filling out your movie library form.";

                // Pulling information from the form and creating a MovieLibrary object
...
>>>>>>> f9a4cb91454a3a956af8db6cc2a4c82f6266ec4f
        }
    }
}