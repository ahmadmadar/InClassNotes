...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-6">
        ...
        <div>
            ...
            <asp:ValidationSummary ID="ValidaionSummary" runat="server" CssClass="alert-warning alert-dismissible" HeaderText="Please fix the following problems before submitting this form." />
            ...
            <asp:RequiredFieldValidator ID="ValidateYear" runat="server" Display="None" ControlToValidate="Year" ErrorMessage="A year is required." />
            ...
            <asp:RequiredFieldValidator ID="ValidateMediaType" runat="server" Display="None" ControlToValidate="Media" ErrorMessage="You must indicate the media on which the movie is stored." />
        </div>
    </div>
</asp:Content>
